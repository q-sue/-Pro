    ...
    <div class="content">
      <div class="left-wrap">
        <div class="user-wrap box-style">
          ...
          <p class="des">审知 Pro 是一款审计智能化工具，致力于为审计行业提供高效、便捷的解决方案。</p>

          <div class="outer-info">
            <div>
              <i class="iconfont-sys">&#xe72e;</i>
              <span>YNU@mall.com</span>
            </div>
            <div>
              <i class="iconfont-sys">&#xe608;</i>
              <span>审计专家</span>
...
<script setup lang="ts">
  ...
  const form = reactive({
    ...
    address: '云南省昆明市',
    sex: '2',
    des: '审知 Pro 是一款审计智能化工具，致力于为审计行业提供高效、便捷的解决方案。'
  })
  ...
  const lableList: Array<string> = ['专注设计', '审计', '审知 Pro', 'YNU', '海纳百川']
